...
export interface Material { type: string, price: number, unit?: string, utility?: string, lambda?: number }
...
export const materials: Material[] = [
    ...
    { type: 'Einangrun', price: 4000, unit: 'sqrm', utility: 'floor', lambda: 0.034 },
