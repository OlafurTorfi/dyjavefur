...
exports.getDoors = function () { return __awaiter(_this, void 0, void 0, function () {
    var res, doors;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.query("select \"FamilyName\", \"TypeName\", \"Width\", \"Height\" from \"Doors\" as \"d\"\n    join \"DoorTypes\" as \"dt\" on d.\"TypeId\"=dt.\"Id\"")];
            case 1:
                res = _a.sent();
                doors = res.rows.map(function (d) {
                    var doorPrice = doorPrices.find(function (dp) { return dp.type === d.TypeName; });
...
//# sourceMappingURL=door.1.js.map