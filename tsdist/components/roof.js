...
var roofTypes = [{
    ...
    materials: [{
        ...
        {
            type: 'Skrúfur í Cembritvegg',
            amount: 1
        }
    ]
}];
exports.getRoofs = function () {
    return __awaiter(_this, void 0, void 0, function () {
        var res, roofs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/ , db_1.query("select \"Area\", \"FamilyName\", \"TypeName\" from \"Roofs\" as w\n    join \"RoofTypes\" as wt on w.\"TypeId\"=wt.\"Id\"")];
                case 1:
                    res = _a.sent();
                    roofs = res.rows.map(function (roof) {
                        var roofType = roofTypes.find(function (Roofp) {
                        ...
                        var calc = roofType && roofType.materials.reduce(function (prev, curr) {
                            var materialType = materials_1.materials.find(function (materialp) {
                                return materialp.type === curr.type;
                            });
